...
$query = "SELECT * from tbl_count_votes where position_name = 'BSCS Representatives' ORDER BY votes DESC";//query to select top 10
...
$html = '<h1>Tally of Votes(CS Representatives)</h1>
